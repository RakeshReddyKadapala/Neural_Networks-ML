# -*- coding: utf-8 -*-
"""
Created on Sat Mar  4 16:31:25 2023
...
salary.head()
 ...
 Y = salary['Salary'].values
  ...
  #class for linear regression function
...
#error for both train and test in linear regression
#Python scikit-learn train_test_split function to randomly split our data into a training and test set.
from sklearn.model_selection import train_test_split
from sklearn import metrics
X_train, X_test, y_train, y_test = train_test_split(X,Y, test_size=0.3, random_state=42)
...
#Executing MLE
lik_model = minimize(lik, np.array([2, 2, 2]), args=(X_m,Y_m,), constraints=cons,method='L-BFGS-B')
lik_model
...
print("Mean absolute error (MAE) using maximum likelihood estimator:", metrics.mean_absolute_error(y_test,y_pred_mle))

#Printing mean square error for test set
print("Mean square error (MSE) using maximum likelihood estimator:", metrics.mean_squared_error(y_test,y_pred_mle))
...
print("Mean absolute error (MAE) for training set using maximum likelihood estimator:", metrics.mean_absolute_error(y_train,y_pred_for_train_mle))

#Printing mean square error for training set
print("Mean square error (MSE) for training set using maximum likelihood estimator:", metrics.mean_squared_error(y_train,y_pred_for_train_mle))
